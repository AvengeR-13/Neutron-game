...
export class GameBoard {
    ...
    board = [
        [
            new Pawn("W5","White",0,0),
            new Pawn("W1","White",1,0),
            new Pawn("W2","White",2,0),
            new Pawn("W3","White",3,0),
            new Pawn("W4","White",4,0)
        ],
    ...
    #showPossibleMovement = event => {
        ...
        if (this.game.currentPlayer !== pawnAffiliation) return
